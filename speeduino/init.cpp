...
static inline void applyMotoProfileConfig(void)
{
  configPage2.aeMode = AE_MODE_TPS;
  configPage2.aeApplyMode = AE_MODE_ADDER;

  #if MOTO_PROFILE_DISABLE_BOOST_CONTROL
  configPage6.boostEnabled = 0;
  configPage9.boostByGearEnabled = 0;
  #endif

  #if MOTO_PROFILE_DISABLE_NITROUS
  configPage10.n2o_enable = 0;
  #endif

  #if MOTO_PROFILE_DISABLE_WMI
  configPage10.wmiEnabled = 0;
  #endif

  #if MOTO_PROFILE_DISABLE_AIRCON
  configPage15.airConEnable = 0;
  #endif

  #if MOTO_PROFILE_DISABLE_PROGRAMMABLE_IO
  for (byte i = 0; i < _countof(configPage13.outputPin); i++) { configPage13.outputPin[i] = 0; }
  #endif

  #if MOTO_PROFILE_DISABLE_SD_LOGGING
  configPage13.onboard_log_file_style = 0;
  configPage13.onboard_log_trigger_Epin = 0;
  #endif

  #if MOTO_PROFILE_DISABLE_SECONDARY_SERIAL
  configPage9.enable_secondarySerial = 0;
  configPage9.secondarySerialProtocol = 0;
  #endif

  #if MOTO_PROFILE_DISABLE_CAN
  configPage9.enable_intcan = 0;
  configPage9.enable_candata_out = 0;
  #endif

  #if MOTO_PROFILE_DISABLE_GEAR_DETECTION
  currentStatus.gear = 0;
  #endif

  #if MOTO_PROFILE_DISABLE_CTPS
  configPage2.CTPSEnabled = 0;
  #endif

  #if MOTO_PROFILE_DISABLE_CAN_WBO
  configPage2.canWBO = 0;
  #endif

  configPage10.knock_mode = 0;
  configPage10.stagingEnabled = 0;
  configPage6.vvtEnabled = 0;
  configPage10.vvt2Enabled = 0;
  configPage6.useEMAP = 0;
  configPage2.flexEnabled = 0;

  configPage10.fuel2Algorithm = LOAD_SOURCE_MAP;
  configPage10.fuel2Mode = FUEL2_MODE_MULTIPLY;
  configPage10.fuel2SwitchVariable = FUEL2_CONDITION_MAP;
  configPage10.fuel2SwitchValue = 0;
  configPage10.fuel2InputPin = 0;
  configPage10.fuel2InputPolarity = 0;
  configPage10.fuel2InputPullup = 0;
  ...
  {
    configPage10.spark2Mode = SPARK2_MODE_ADD;
  }
  configPage10.spark2SwitchVariable = SPARK2_CONDITION_TPS;
  configPage10.spark2SwitchValue = 0;
  configPage10.spark2InputPin = 0;
  configPage10.spark2InputPolarity = 0;
  configPage10.spark2InputPullup = 0;
}
