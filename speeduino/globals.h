...
#ifndef UNIT_TEST 
  #ifdef MOTO_PROFILE_TOOTH_LOG_SIZE
    #define TOOTH_LOG_SIZE  MOTO_PROFILE_TOOTH_LOG_SIZE
  #else
...
#if MOTO_PROFILE_SHARE_UNUSED_TABLES
extern struct table3d8RpmLoad motoUnusedTable3d8;
#define stagingTable motoUnusedTable3d8
#define boostTable motoUnusedTable3d8
#define boostTableLookupDuty motoUnusedTable3d8
#define vvtTable motoUnusedTable3d8
#define vvt2Table motoUnusedTable3d8
#define wmiTable motoUnusedTable3d8
#else
...
#if MOTO_PROFILE_SHARE_UNUSED_TABLES
extern trimTable3d motoUnusedTrimTable3d;
#define trim1Table motoUnusedTrimTable3d
#define trim2Table motoUnusedTrimTable3d
#define trim3Table motoUnusedTrimTable3d
#define trim4Table motoUnusedTrimTable3d
#define trim5Table motoUnusedTrimTable3d
#define trim6Table motoUnusedTrimTable3d
#define trim7Table motoUnusedTrimTable3d
#define trim8Table motoUnusedTrimTable3d
#else
...
#if MOTO_PROFILE_SHARE_UNUSED_TABLES
extern struct table2D motoUnusedTable2D;
#define flexFuelTable motoUnusedTable2D
#define flexAdvTable motoUnusedTable2D
#define flexBoostTable motoUnusedTable2D
#define fuelTempTable motoUnusedTable2D
#define knockWindowStartTable motoUnusedTable2D
#define knockWindowDurationTable motoUnusedTable2D
#define wmiAdvTable motoUnusedTable2D
#else
...
#if MOTO_PROFILE_SHARE_UNUSED_PINS
extern byte motoUnusedPin;
#define pinEMAP motoUnusedPin
#define pinMAP2 motoUnusedPin
#define pinDisplayReset motoUnusedPin
#define pinFuel2Input motoUnusedPin
#define pinSpark2Input motoUnusedPin
#define pinFlex motoUnusedPin
#define pinWMIEmpty motoUnusedPin
#define pinWMIIndicator motoUnusedPin
#define pinWMIEnabled motoUnusedPin
#define pinSDEnable motoUnusedPin
#define pinAirConComp motoUnusedPin
#define pinAirConFan motoUnusedPin
#define pinAirConRequest motoUnusedPin
#else
...
extern uint16_t calibrationBins[32];
#define cltCalibration_bins calibrationBins
extern uint16_t cltCalibration_values[32];
#define iatCalibration_bins calibrationBins
extern uint16_t iatCalibration_values[32];
#define o2Calibration_bins calibrationBins
